...
router.post("/new", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, logger_1.log)("NEW SCORE CARD.");
    if (!(player_id && game_id)) {
        return res.json({ message: "missing information" });
    }
    try {
        const linkedPlayer = yield (0, model_1.scoreCard)(player_id, game_id);
        if (!linkedPlayer.ok) {
...
router.get("/player/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result;
    try {
        result = (0, model_1.getGames)(player_id); // return this player's games.
    }
    catch (err) {
        if (err instanceof Error)
...
router.get("/player/:pid/game/:gid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result;
    try {
        result = yield (0, model_1.getPlayerScore)(player_id, game_id);
    }
    catch (err) {
        if (err instanceof Error)
            return res.json({ error: err.message });
...
router.get("/games/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result;
    try {
        result = (0, model_1.getPlayers)(game_id); // return this game's players.
    }
    catch (err) {
        if (err instanceof Error)
            return res.json({ error: err.message });
...
router.put("/increase/:player_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield (0, model_1.addPoints)(player_id, game_id, points);
        return res.json(result);
    }
    catch (err) {
        if (err instanceof Error)
...
router.put("/decrease/:player_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield (0, model_1.subPoints)(player_id, game_id, points);
        return res.json(result);
    }
    catch (err) {
        if (err instanceof Error)
...
router.put("/def/:player_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        result = yield (0, model_1.updateDefinition)(player_id, game_id, Number(top_definition_id));
        const { score } = result;
        if (result.ok) {
        }
        else {
...
router.post("/latest/:game_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let leaderboard;
    try {
        leaderboard = yield (0, model_1.getLatest)(game_id);
    }
    catch (err) {
    ...
    leaderboard.latest.forEach((scoreCard) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, logger_1.log)(`looking up top definition for player ${player_id}`);
        const checkTop = yield (0, model_1.findTopDefinition)(player_id, game_id); // sort
        ...
        if (latest_top_def && top_definition_id !== latest_top_def) {
            (0, logger_1.log)("top definition changed... updating score-card"); // update
            yield (0, model_1.updateDefinition)(player_id, game_id, latest_top_def);
            countdown -= 1;
            latestScore = [
                ...latestScore,
                {
            ...
            (0, logger_1.log)(`top definition remains to be ${top_definition_id}`);
            countdown -= 1;
