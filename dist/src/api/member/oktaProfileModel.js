...
const findAll = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, dbConfig_1.default)('profiles');
});
const findBy = (filter) => {
    return (0, dbConfig_1.default)('profiles').where(filter);
};
const findById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, dbConfig_1.default)('profiles').where({ id }).first().select('*');
});
const create = (profile) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, dbConfig_1.default)('profiles').insert(profile).returning('*');
});
const update = (id, profile) => {
    return (0, dbConfig_1.default)('profiles')
        .where({ id: id })
        .first()
        .update(profile)
        .returning('*');
...
const remove = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield (0, dbConfig_1.default)('profiles').where({ id }).del();
});
