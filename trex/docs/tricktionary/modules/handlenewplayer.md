[tricktionary-be](../README.md) / [Exports](../modules.md) / handleNewPlayer
...
Defined in: [handleNewPlayer.ts:9](https://github.com/story-squad/tricktionary-be/blob/2d7399d/src/sockets/handleNewPlayer.ts#L9)
